...
def get_dashboard(
    ...
    return {
        ...
        "stats": {
            "joined_groups": len(my_groups),
            "upcoming_sessions": total_upcoming_session_count,
            "unread_updates": unread_notification_count,
